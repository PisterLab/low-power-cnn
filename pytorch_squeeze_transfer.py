...
# print('Printing current parameters:')
# for name, params in model_conv.named_children():
#     print(name)
# print('--- --- ---')

# Define new classifier parameters
...
# Now only last two layers have non-frozen gradients
# for param in model_conv.parameters():
...
# opoosed to before.
# filter(lambda p: p.requires_grad, model_conv.parameters()) picks out layers to be optimized
